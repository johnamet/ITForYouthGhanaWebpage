...
export function TrainingWhoCanApplyPage() {
  return (
    <div className="bg-white">
      <section className="relative overflow-hidden bg-brand-navy text-white">
        <div className="absolute inset-0">
          <Image
            src={trainingEligibilityContent.heroImage}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
          {trainingEligibilityContent.audienceCards.map((card) => (
            <div
              key={card.title}
      ...
      <section className="bg-brand-mist/45 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="space-y-4">
            {trainingEligibilityContent.readinessPoints.map((point) => (
              <div
                key={point}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <RouteCardGrid cards={trainingEligibilityContent.nextSteps} />
        </div>
      </section>
    </div>
  );
