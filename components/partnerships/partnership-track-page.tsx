    ...
    <div className="bg-white">
      ...
      <section id="overview" className="mx-auto max-w-7xl scroll-mt-36 px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <SectionHeading
            ...
            title="Where this track creates the most practical value"
            description="The cards below outline the strengths, collaboration models, and ecosystem value that tend to make this partner track especially useful."
          />
      ...
      >
        <div className="mx-auto max-w-7xl space-y-8">
          <SectionHeading
            ...
            title="A clearer partnership sequence helps both sides move with more confidence"
            description="The strongest partnerships usually begin with fit and role clarity, then move into a scoped collaboration that can grow once trust and value are visible."
          />
      ...
      >
        <div className="space-y-8">
          <SectionHeading
            ...
            title="Representative patterns of how this track can work in practice"
            description="These are seeded examples that show the shape of a strong collaboration before live case-study publishing is wired into the CMS."
          />
      ...
      <section id="faqs" className="bg-brand-mist/45 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl space-y-8">
          <SectionHeading
            eyebrow="FAQs"
            title="Questions partners often need answered before they commit"
            description="A clearer answer early usually removes more friction than a longer generic pitch. These FAQs address the most common starting uncertainties."
          />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <SectionHeading
            ...
            title="Keep the partnership conversation moving"
            description="These adjacent routes often become the next useful step once the first partnership shape is clearer."
          />
