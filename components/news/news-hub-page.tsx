      ...
      <section className="relative overflow-hidden bg-brand-navy text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt="IT For Youth Ghana news and updates"
            fill
            priority
            sizes="100vw"
            className="object-cover"
          />
          <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(10,27,52,0.94)_0%,rgba(10,27,52,0.78)_48%,rgba(10,27,52,0.35)_100%)]" />
        </div>
