    ...
    <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
      {visibleCards.map((card) => (
        ...
        >
          ...
          <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-brand-navy">
            <svg
              viewBox="0 0 24 24"
              className="h-5 w-5 fill-none stroke-brand-gold stroke-[1.5]"
              strokeLinecap="round"
          ...
          {card.eyebrow && (
            <p className="mb-1.5 text-[0.6rem] font-bold uppercase tracking-[0.28em] text-brand-gold">
              {card.eyebrow}
            </p>
          )}
