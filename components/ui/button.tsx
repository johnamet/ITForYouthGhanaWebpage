...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  pink: "border-brand-gold bg-brand-gold text-white hover:border-brand-gold hover:bg-brand-gold hover:text-white",
  ...
  "pink-outline": "border-brand-gold bg-brand-gold text-white hover:border-brand-gold hover:bg-brand-gold hover:text-white",
