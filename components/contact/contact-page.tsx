        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.42fr_0.58fr] lg:items-start">
          <div className="space-y-8">
            <SectionHeading
              ...
              description="The form validates through the Next route handler now. In production, the same route can send Brevo email notifications and later persist to Firestore contactMessages."
            />
          ...
          <div className="rounded-[34px] border border-brand-border bg-white p-6 shadow-sm sm:p-8">
            <div className="mb-8 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-slate-600">
                  Choose the closest route, add context, and the site will validate the submission through `/api/contact`.
                </p>
              </div>
            </div>
