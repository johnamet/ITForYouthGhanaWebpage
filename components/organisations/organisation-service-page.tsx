    ...
    <div className="bg-white">
      ...
      <section id="overview" className="mx-auto max-w-7xl scroll-mt-36 px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <SectionHeading
            ...
            title="What this route can look like in practice"
            description="The cards below outline the kinds of support, structure, and value this service can create when it is designed around the organisation’s real context."
          />
      ...
      >
        <div className="mx-auto max-w-7xl space-y-8">
          <SectionHeading
            ...
            title="A clearer engagement sequence helps both sides move faster"
            description="Most organisational conversations go better when the steps are explicit early: clarify fit, scope the work, deliver the experience, then decide what the next layer of collaboration should be."
          />
      ...
      >
        <div className="space-y-8">
          <SectionHeading
            ...
            title="Representative examples of how the engagement can create value"
            description="These are seeded example patterns to show what a strong collaboration can look like in practice even before live case-study publishing is wired into the CMS."
          />
      ...
      <section id="faqs" className="mx-auto max-w-7xl scroll-mt-36 px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <SectionHeading
            eyebrow="FAQs"
            title="Questions organisations often need answered before moving"
            description="A clear answer early can save a lot of unnecessary back-and-forth. These FAQs cover the most common starting uncertainties."
          />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <SectionHeading
            ...
            description="These adjacent routes often become the next useful conversation once the first collaboration shape is clear."
          />
