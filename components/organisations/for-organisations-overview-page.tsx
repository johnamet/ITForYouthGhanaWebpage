    ...
    <div className="bg-white">
      <section className="relative overflow-hidden bg-brand-navy text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          ...
          >
            ...
            <span>/</span>
            <span className="text-white">For Organisations</span>
          </nav>
      ...
      <section id="overview" className="mx-auto max-w-7xl scroll-mt-36 px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <SectionHeading
            eyebrow="Overview"
            title="A partner route should match the decision the organisation is actually making"
            description="Some teams want internal training. Others want visible mission support, early-career talent, or a meaningful volunteering pathway. The section below helps organisations choose the right starting point instead of flattening everything into one generic partnership pitch."
          />
      ...
      >
        <div className="mx-auto max-w-7xl space-y-10">
          <SectionHeading
            ...
            title="Choose the collaboration model that fits your organisation best"
            description="Each service route has a dedicated page with a clearer offer, delivery model, examples, FAQs, and next-step CTA."
          />
        ...
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[32px] bg-brand-navy p-8 text-white">
            ...
            <p className="mt-4 text-base leading-8 text-white/78">
              Organisations usually move faster when the collaboration route is framed around one
              immediate decision first. The relationship can still deepen afterwards.
            </p>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl space-y-8">
          <SectionHeading
            eyebrow="Next steps"
            title="Start with the route that feels most immediate"
            description="If you already know the type of collaboration you want, jump into that service page. If you still need help choosing, the contact route is the best next move."
          />
