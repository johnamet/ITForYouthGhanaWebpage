        ...
        <aside className="h-fit rounded-[28px] border border-brand-border bg-brand-mist/45 p-5">
          <div className="rounded-[22px] bg-white p-5 shadow-sm">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-5 inline-flex w-full justify-center rounded-full bg-brand-gold px-5 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:shadow-md"
            >
