...
const base =
  "inline-flex items-center justify-center gap-2 rounded-control border-[1.5px] px-6 py-3.5 text-[0.9375rem] font-bold transition duration-200 hover:-translate-y-0.5 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#05070f]";
...
export function CapsuleActions({
  ...
  return (
    <div className={cn("mt-[30px] flex flex-wrap gap-3 max-[820px]:justify-center", className)}>
      <Link
        href={primary.href}
        className={cn(base, "border-brand-accent bg-brand-accent text-white hover:bg-brand-accent-dark hover:border-brand-accent-dark")}
      >
        {primary.label}
        <span
          aria-hidden="true"
