    ...
    <div className="bg-white">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <SectionHeading
            eyebrow="Written and partner voices"
            title="Different angles on what meaningful change feels like"
            description="These stories are seeded to show the structure of the future testimonial system: learner progression, gender inclusion, partner trust, and transition into work."
          />
      ...
      <section className="bg-brand-mist/45 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl space-y-8">
          <SectionHeading
            eyebrow="Next steps"
            title="Use the wider impact system to add context around the stories"
            description="Stories become more persuasive when they sit alongside the evidence base and the programme ecosystem they came from."
          />
