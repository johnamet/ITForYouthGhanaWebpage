...
export const contactPageContent: ContactPageContent = {
  ...
  responseSteps: [
    ...
    },
    {
      ...
      title: "Review",
      description:
        "The API validates the message now and can send it through Brevo notifications when production environment variables are configured.",
    },
    {
      number: "03",
      title: "Respond",
  ...
  privacyNote:
    "Your message is used only to respond to your enquiry and route it internally. Firestore persistence and admin review workflows will be added in the CMS phase.",
};
