...
export const homepageSectionConfigs: AdminHomepageSectionConfig[] = [
  ...
  },
  {
    ...
    route: "/admin/content/homepage",
    status: trainingLandingContent.focusAreas.length ? "live" : "planned",
  ...
  {
    id: "partnerships",
    label: "Partnership routes",
    route: "/partner-with-us",
    status: partnershipTracks.length ? "live" : "planned",
    collection: FIREBASE_COLLECTIONS.siteContent,
    description: "Partner-facing routes that can be promoted from homepage CTAs.",
  },
  {
    id: "donation",
  ...
  },
  {
    ...
    route: "/admin/settings",
    status: "planned",
    collection: FIREBASE_COLLECTIONS.newsletterSubs,
    description: "Mailing list capture and Brevo subscription integration.",
  },
];
...
export const adminContentSections = {
  homepage: {
    ...
    description: "Control the 13 homepage sections, their visibility, ordering, and linked collection contracts.",
