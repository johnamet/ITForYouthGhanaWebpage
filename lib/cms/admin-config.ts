...
export const cmsCollections: AdminCollectionDefinition[] = [
  ...
  },
  {
    ...
    route: "/admin/cms/page-apply-for-training",
  ...
  },
  {
    ...
    route: "/admin/cms/initiative/girls-in-tech",
...
export const homepageSectionConfigs: AdminHomepageSectionConfig[] = [
  ...
  {
    id: workspaceSectionsById.marquee.id,
    label: workspaceSectionsById.marquee.label,
    route: "/admin/content/homepage",
    status: "live",
    collection: FIREBASE_COLLECTIONS.homepage,
    description: workspaceSectionsById.marquee.description,
  },
  {
  ...
  {
    id: workspaceSectionsById["challenge-section"].id,
    label: workspaceSectionsById["challenge-section"].label,
    route: "/admin/content/homepage",
    status: "live",
    collection: FIREBASE_COLLECTIONS.homepage,
    description: workspaceSectionsById["challenge-section"].description,
  },
  {
    id: workspaceSectionsById["mission-section"].id,
    label: workspaceSectionsById["mission-section"].label,
    route: "/admin/content/homepage",
    status: "live",
    collection: FIREBASE_COLLECTIONS.homepage,
    description: workspaceSectionsById["mission-section"].description,
  },
  {
    id: workspaceSectionsById["programme-showcase"].id,
    label: workspaceSectionsById["programme-showcase"].label,
    route: "/admin/content/homepage",
    status: "live",
    collection: FIREBASE_COLLECTIONS.homepage,
    description: workspaceSectionsById["programme-showcase"].description,
  },
  {
    id: "articles",
  ...
  {
    id: workspaceSectionsById["join-cta"].id,
    label: workspaceSectionsById["join-cta"].label,
    route: "/admin/content/homepage",
    status: "live",
    collection: FIREBASE_COLLECTIONS.homepage,
    description: workspaceSectionsById["join-cta"].description,
  },
  {
    id: "donation",
  ...
  {
    id: workspaceSectionsById.newsletter.id,
    label: workspaceSectionsById.newsletter.label,
    route: "/admin/content/homepage",
    status: "live",
    collection: FIREBASE_COLLECTIONS.homepage,
    description: workspaceSectionsById.newsletter.description,
  },
];
